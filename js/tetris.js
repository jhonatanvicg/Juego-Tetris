...
const context = canvas.getContext('2d')//Con esto le estamos dando los metodos para dibujar lineas,etc
...
context.scale(20,20)//filascolumnas
...
function drawMatrizNext(matriz,offset){
  ...
  contextNext.fillRect(0,0,canvas.width, canvasNext.height)
...
function playerReset(){
  ...
  player.pos.y = 0
  if(collide(grid, player)){
    swal('Eres muy lento','Jajajaja te humilló la maquina','error')
